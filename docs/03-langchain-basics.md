...
- [<랭체인LangChain 노트> — 테디노트, WikiDocs](https://wikidocs.net/book/14314) — LCEL·프롬프트·파서·도구까지 이 챕터 전체를 한국어 실습 코드로 다루는 무료 책(국내에서 가장 널리 읽히는 LangChain 한국어 튜토리얼).
- [teddylee777/langchain-kr — GitHub](https://github.com/teddylee777/langchain-kr) — 위 책의 전체 예제를 바로 실행해 볼 수 있는 주피터 노트북 저장소.
- [랭체인(LangChain) 입문부터 응용까지 — WikiDocs](https://wikidocs.net/book/14473) — 체인 구성과 모델 연동을 단계별로 익히는 또 다른 무료 한국어 입문서.
- [10분만에 랭체인(LangChain) 이해하기 — 브런치](https://brunch.co.kr/@ywkim36/147) — 코드 없이 비유 중심으로 "LangChain이 무엇을 추상화하는지"를 빠르게 잡아주는 글.
